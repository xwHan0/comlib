...
class TestTreeDirection:
    def test_down_up(self):
        """DOWN-UP全遍历测试"""
        a = [10,20,[30,40,[50,60]]]
        rst = [n.value[0] for n in tree(a, dir='downup')]
        print("Result is: " + str(rst))
        assert rst == [[10,20,[30,40,[50,60]]], 10, 20, [30,40,[50,60]], 30,40, [50,60],50,60,[50,60],[30,40,[50,60]],[10,20,[30,40,[50,60]]]]

    def test_down(self):
        a = [10,20,[30,40,[50,60]]]
        rst = [n.value[0] for n in tree(a, dir='down')]
        print("Result is: " + str(rst))
        assert rst == [[10,20,[30,40,[50,60]]], 10, 20, [30,40,[50,60]], 30,40, [50,60],50,60,]
